...
<html lang="en">
  ...
  function singUp(){
      ...
      if(id.length > 20){
          alert('아이디는 최대 20자리입니다.');
          return;
      } else if(pwd.length > 20){
          alert('비밀번호는 최대 20자리 입니다.');
          return;
      } else if(pwdConfirm.length > 20){
          alert('비밀번호 재확인은 최대 20자리입니다.'); 
          return;
      } else if(name.length > 30){
           alert('이름은 최대 30자리 입니다.'); 
           return;
	...
	<form>
		<div class="container" style="width:500px;">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="id" name="id" placeholder="아이디를 입력하여 주세요.">
			</div>
			<div class="form-group">
				<label for="exampleInputPassword1">비밀번호</label>
				<input type="password" class="form-control" id="pwd" name="pwd" placeholder="비밀번호를 입력하여 주세요.">
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">비밀번호 재확인</label>
				<input type="password" class="form-control" id="pwdConfirm" name="pwdConfirm" placeholder="비밀번호를 다시 입력하여 주세요.">
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">이름</label>
				<input type="text" class="form-control" id="name" name="name" placeholder="이름을 입력하여 주세요.">
			</div>
            <div class="form-group">
			...
			<div class="form-group">
				...
				<div>
				<select class="form-control" id="dateOfBirthYear"  name="dateOfBirthYear"  style="width:40%;float:left;">
				</select>
				<select class="form-control" id="dateOfBirthMonth" name="dateOfBirthMonth" style="width:30%;float:left;">
				</select>
				<select class="form-control" id="dateOfBirthDay"   name="dateOfBirthDay"   style="width:30%;">
                </select>
				</div>
			</div>
			<div class="form-group">
            ...
            <div class="form-group">
                ...
                <select id="nationNo" name="nationNo" class="form-control" aria-label="전화번호 입력">
                ...
                <input style="margin-top: 7px;" type="text" class="form-control" id="phoneNumber" name = "phoneNumber" placeholder="전화번호를 입력하여 주세요.">
            </div>			
			<div class="form-group">
